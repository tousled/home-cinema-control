...
class JellyfinPlaybackRequestTest(unittest.TestCase):
    ...
    def test_uses_id_as_session_fallback_for_legacy_request_payload(self):
        params = parse_playback_request_payload(
            {
                "ItemIds": ["item-1"],
...
class BuildPlaybackIntentFromPlayCommandTest(unittest.TestCase):
    def test_uses_session_id_when_jellyfin_provides_it(self):
