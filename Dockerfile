...
ARG HCC_TELEMETRY_ENDPOINT_URL=""
ARG HCC_TELEMETRY_INGEST_KEY=""
ENV HCC_TELEMETRY_ENDPOINT_URL=${HCC_TELEMETRY_ENDPOINT_URL}
ENV HCC_TELEMETRY_INGEST_KEY=${HCC_TELEMETRY_INGEST_KEY}
